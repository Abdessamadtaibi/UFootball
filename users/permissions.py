...
class IsStaffOrParentUserType(IsAuthenticatedAnd):
    def _passes(self, user):
        return (
...
class IsStaffOrCoachOrParentUserType(IsAuthenticatedAnd):
    def _passes(self, user):
        return (
            getattr(user, 'is_staff_member', lambda: False)() or
            getattr(user, 'is_coach', lambda: False)() or
            getattr(user, 'is_parent', lambda: False)()
        )
...
class IsAdminOrStaffOrCoachOrParentUserType(IsAuthenticatedAnd):
    def _passes(self, user):
        return (
            getattr(user, 'is_admin_user', lambda: False)() or
            getattr(user, 'is_staff_member', lambda: False)() or
