...
class MatchEventSerializer(serializers.ModelSerializer):
    ...
    display_player_name = serializers.SerializerMethodField()
    ...
    def get_display_player_name(self, obj):
        # If player FK exists, use player's full name
        player = getattr(obj, 'player', None)
        if player:
            return getattr(player, 'full_name', None)
        # Otherwise use the manual player_name field
...
class MatchLineupSerializer(serializers.ModelSerializer):
    ...
    def get_player_number(self, obj):
        return getattr(obj.player, 'jersey_number', None) if obj.player else None
